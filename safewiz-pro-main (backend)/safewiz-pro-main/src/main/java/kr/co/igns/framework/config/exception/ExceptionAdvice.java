 ...
 * @ 파일명		: ExceptionAdvice.java
 * @ 기능명 		: 에러처리 핸들러 > 각 타입별 오류 매칭
 * @ 작성자 		: 김성준
 * @ 최초생성일 	: 2022. 4. 13.
 */
...
public class ExceptionAdvice {
    ...
    protected CommonResult notBoardFoundException(final Exception e) {
        log.error("notFoundException: {}", e.getMessage());
        return responseService.getFailResult(Integer.valueOf(getMessage("notBoardFound.code")), getMessage("notBoardFound.msg"));
    }
