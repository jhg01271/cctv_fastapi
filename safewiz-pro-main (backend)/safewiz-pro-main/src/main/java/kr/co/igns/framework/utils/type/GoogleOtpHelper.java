...
public class GoogleOtpHelper {
	...
	public static HashMap<String, String> generateOTPKey(String sHost, String sUserid) {
		HashMap<String, String> oRet = new HashMap<String, String>();

		try {
			Random numGen = SecureRandom.getInstance("SHA1PRNG");
			byte[] buffer = new byte[30];
			(numGen).nextBytes(buffer);
