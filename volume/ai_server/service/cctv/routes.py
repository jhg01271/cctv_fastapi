"""
================================================================================
[Router] service/cctv/routes.py
================================================================================
- 역할: CCTV 카메라 관리 도메인의 외부 API 엔드포인트(Router)를 정의합니다.
- 흐름: Frontend 요청 수신 ➡️ DTO 검증(schema.py) ➡️ 비즈니스 로직 호출(service.py) ➡️ 응답 반환
- 주요 기능: 회사별 카메라 목록 조회, 단일 카메라 조회, AI 서버 정보 조회, 카메라 등록/수정, 삭제 API 제공
================================================================================
"""
