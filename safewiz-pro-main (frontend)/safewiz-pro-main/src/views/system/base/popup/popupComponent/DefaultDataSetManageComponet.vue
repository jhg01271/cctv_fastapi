                    ...
                    <div class="row flex gutters1rem">
                        <div class="grid12-8 sm-grid12-12">
                            <div class="field tal">
                                ...
                                <input v-model="item[nm]" v-input type="text" class="w100p radius" :id="`${nm}${index}`" :required="item.checked" :placeholder="`${subTitle}을 입력해주세요.`" @input="chkData(item)" />
                            </div>
                        </div>
                        <div class="grid12-3 sm-grid12-8">
                            <div class="field tal">
                                <label for="ordSeq">
                                    <span>순번</span>
                                </label>
