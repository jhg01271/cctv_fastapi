                        ...
                        <div class="row flex gutters1rem">
                            ...
                            <div class="grid10-2 sm-grid12-6">
                                <div class="field">
                                    ...
                                    <input v-model="shInfoRegisterStore.inputForm.receiptDt" :min="shInfoRegisterStore.searchParam.writeYear + '.01.01'" :max="shInfoRegisterStore.searchParam.writeYear + '.12.31'" id="receiptDt" v-input type="text" v-calendar="getDateFormat()" class="datepicker w100p radius" required />
                                </div>
                            </div>
                            ...
                            <div class="grid12-12 sm-grid12-12">
                                <div class="field">
                                    ...
                                    <textarea id="remark" v-model="shInfoRegisterStore.inputForm.remark" type="text" v-input class="w100p minh10rem radius" placeholder="비고를 입력하세요"></textarea>
                                </div>
                            </div>
                            <div class="grid12-12 sm-grid12-12">
...
import { getShInfoRegisterList } from '@/stores/safewiz/support/api/safetyAndHealthInfoRegisterApi.js';
...
btnSearch(() => {
    ...
    getShInfoRegisterList(searchParam, true).then(res => {
...
const save = async notify => {
    ...
    const result = await shInfoRegisterStore.btnSave(notify);
    if (result) {
        // 저장 성공 시 파일 조회
...
btnDelete(() => {
    shInfoRegisterStore.btnDelete('D');
});
btnDownload(() => {
